...
from shared.character_based import *
from shared.knowledge_based import wu_palmer_similarity_sentence, path_similarity_sentence, \
    leacock_chodorow_similarity_sentence, args_knowledge
from shared.vector_based import args_vector_based, args_minkowski_p, manhattan, euclidean, minkowski, \
    cosine_vector
from shared.sts_method_wrappers import STSMethod
