...
class STSMethod:
    ...
    # Check if this method's args match the desired args
    # Params: dict<string, string>
    # Return: bool
    def args_match(self, desired_args):
        if len(self.args.keys()) != len(desired_args.keys()):
            return False
        ...
        for key in desired_args:
            ...
            if self.args[key] != desired_args[key]:
                return False
